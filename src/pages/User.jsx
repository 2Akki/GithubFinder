      ...
      <div className='w-full mx-auto lg:w-10/12'>
        ...
        <div className='w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats'>
          <div className='grid grid-cols-1 md:grid-cols-3'>
            <div className='stat'>
              <div className='stat-figure text-secondary'><FaUsers className='text-3xl md:text-5xl' ></FaUsers></div>
            ...
            <div className='stat'>
              <div className='stat-figure text-secondary'>
                ...
                <FaUserFriends className='text-3xl md:text-5xl' ></FaUserFriends></div>
            ...
            <div className='stat'>
              <div className='stat-figure text-secondary'>
                ...
                <FaCodepen className='text-3xl md:text-5xl' ></FaCodepen></div>
